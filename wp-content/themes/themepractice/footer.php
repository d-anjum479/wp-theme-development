            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff; height: 2px" />
                        <p>
                            <a href="#" class="text-white nav-link">MDBootstrap</a>
                        </p>
                        <p>
                            <a href="#" class="text-white nav-link">MDWordPress</a>
                        </p>
                        <p>
                            <a href="#" class="text-white nav-link">BrandFlow</a>
                        </p>
                        <p>
                            <a href="#" class="text-white nav-link">Bootstrap Angular</a>
                        </p>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff; height: 2px" />
                        <p>
                            <a href="#!" class="text-white nav-link">Your Account</a>
                        </p>
                        <p>
                            <a href="#!" class="text-white nav-link">Become an Affiliate</a>
                        </p>
                        <p>
                            <a href="#!" class="text-white nav-link">Shipping Rates</a>
                        </p>
                        <p>
